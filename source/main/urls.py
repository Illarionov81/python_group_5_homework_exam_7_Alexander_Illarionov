...
from webapp.views import PollView, OnePollView, PollCreateView, PollUpdateView, PollDeleteView, ArticleCreateView
...
urlpatterns = [
    ...
    path('poll/<int:pk>/comments/add', ArticleCreateView.as_view(), name='poll_comment_add'),
